  ...
  return (
    <div>
      ...
      <div className="container my-10">
        ...
        <p className="mt-3 leading-[1.4]">Last updated: November 04, 2024</p>
        ...
        <h3 className="text-xl font-semibold mt-5">Interpretation</h3>
        <p className="mt-3 leading-[1.4]">
          The words of which the initial letter is capitalized have meanings
          defined under the following conditions. The following definitions
          shall have the same meaning regardless of whether they appear in
          singular or in plural.
        </p>
        <h3 className="text-xl font-semibold mt-5">Definitions</h3>
        <p className="mt-3 leading-[1.4]">
        ...
        <ul className="list-disc pl-9">
          ...
          <li>
            <p className="mt-3 leading-[1.4]">
              ...
              in this Agreement) refers to currentvpn.io.
            </p>
          </li>
          <li>
            <p className="mt-3 leading-[1.4]">
          ...
          <li>
            <p className="mt-3 leading-[1.4]">
              <strong>Website</strong> refers to currentvpn.io, accessible from{" "}
              <a
                className="underline text-blue-500"
                href="https://currentvpn.io"
        ...
        <h2 className="text-2xl font-semibold mt-8">Disputes Resolution</h2>
        <p className="mt-3 leading-[1.4]">
        ...
        <h2 className="text-2xl font-semibold mt-8">Severability and Waiver</h2>
        <h3 className="text-xl font-semibold mt-5">Severability</h3>
        <p className="mt-3 leading-[1.4]">
        ...
        <h3 className="text-xl font-semibold mt-5">Waiver</h3>
        <p className="mt-3 leading-[1.4]">
        ...
        <ul className="list-disc pl-9 mt-3 space-y-2">
          <li>By email: support@currentvpn.io</li>
        </ul>
      </div>
